...
class Calendar {
            ...
            if(toDay.getFullYear() == this.nowDate.getFullYear()) {
                ...
                if(toDay.getMonth() == this.nowDate.getMonth()) {
                    ...
                    if(this.nowDate.getDate() > day && Math.sign(day) == 1) {
                        ...
                        column.onclick = () => { this.calendarChoiceDay(column); }
                    }
    ...
    async calendarChoiceDay(column) {        
        ...
        if(document.getElementsByClassName("choiceDay")[0]) {
            ...
            // @see 금일인 경우
            if(document.getElementById("calMonth").innerText == autoLeftPad((this.nowDate.getMonth() + 1), 2) && document.getElementsByClassName("choiceDay")[0].innerText == autoLeftPad(this.toDay.getDate(), 2)) {
